...
export function RetailerLedger(props) {
    ...
    return (
        <Fragment>
            ...
            <section className="wrap">
                ...
                <RetailerPageMenu {...router} active={'ledger'} />
            </section>
            <Ledger retailerId={router.query.retailerId} userDetail={userDetail} />
        </Fragment>
    );
}
...
export default withAppContext(RetailerLedger);
