...
const FavouriteItemMobile = (props) => {
    const { item } = props;
    ...
    return (
        <div className="favourite-item mobile">
            <div className="favourite-item-content">
                ...
                <div className="favourite-item-details">
                    <div className="favourite-item-info">
                        ...
                        <div className="remove-favourite d-hide">
                            <ButtonWraper
                                type="danger"
            ...
            {inventoryValidation &&
                <Text type={'danger'} className={'inventory-validation-error p-l10 p-r10 p-b5'}>{langs.validationMessages.inventoryValidation}</Text>
            }
        </div>
    );
};
export default FavouriteItemMobile;
